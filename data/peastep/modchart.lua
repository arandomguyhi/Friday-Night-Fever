...
function onUpdate(elapsed)
	...
	for i=0,3 do
	    setProperty('opponentStrums.members['..i..'].y', _G['defaultOpponentStrumY'..i] + 50 * math.sin((currentBeat + i*25) * math.pi))
	    for i=4,7 do
		setProperty('playerStrums.members['..(i%4)..'].y', _G['defaultPlayerStrumY'..(i%4)] + -50 * math.sin((currentBeat + i*25) * math.pi))
	    end
	end
    end
	...
	local currentBeat = (getSongPosition() / 1000)*(curBpm/60)
	for i=0,3 do
	    setProperty('opponentStrums.members['..i..'].x', _G['defaultOpponentStrumX'..i] + -50 * math.sin((currentBeat + i*50) * math.pi))
	    for i=4,7 do
		setProperty('playerStrums.members['..(i%4)..'].y', _G['defaultPlayerStrumY'..(i%4)] + 50 * math.sin((currentBeat + i*50) * math.pi))
	    end
	end
    end
	...
	local currentBeat = (getSongPosition() / 1000)*(curBpm/60)
	for i=0,3 do
	    setProperty('opponentStrums.members['..i..'].y', _G['defaultOpponentStrumY'..i] + -50 * math.sin((currentBeat + i*50) * math.pi))
	    for i=4,7 do
		setProperty('playerStrums.members['..(i%4)..'].x', _G['defaultPlayerStrumX'..(i%4)] + 50 * math.sin((currentBeat + i*50) * math.pi))
	    end
	end
    end
	...
	for i=0,7 do
	    ...
	    setProperty((i > 3 and 'playerStrums' or 'opponentStrums')..'.members['..(i%4)..'].x', _G[note..'X'..(i%4)] + -50 * math.sin((currentBeat + i*50) * math.pi))
	end
    end
	...
	local currentBeat = (getSongPosition() / 1000)*(curBpm/2)
	for i=0,7 do
	    local note = i > 3 and 'defaultPlayerStrum' or 'defaultOpponentStrum'
