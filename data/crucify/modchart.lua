...
function onUpdate(elapsed)
    if curStep >= 1 and curStep < 12 then
	...
	for i=0,7 do
	    ...
	    setProperty('strumLineNotes.members['..i..'].y', _G[member..'Y'..(i%4)] + 5 * math.cos((currentBeat + i*0.25) * math.pi))
	end
    end
	...
	for i=0,7 do
	    local member = i > 3 and 'defaultPlayerStrum' or 'defaultOpponentStrum'
	    setProperty('strumLineNotes.members['..i..'].y', _G[member..'Y'..(i%4)] + 25 * math.cos((currentBeat + i*5) * math.pi))
	end
    end
	...
	for i=0,7 do
	    local member = i > 3 and 'defaultPlayerStrum' or 'defaultOpponentStrum'
	    setProperty('strumLineNotes.members['..i..'].y', _G[member..'Y'..(i%4)] + -120 * math.cos((currentBeat + i*10) * math.pi))
	end	
    end
	...
	for i=0,7 do
	    local member = i > 3 and 'defaultPlayerStrum' or 'defaultOpponentStrum'
	    setProperty('strumLineNotes.members['..i..'].y', _G[member..'Y'..(i%4)] + 118 * math.cos((currentBeat + i*10) * math.pi))
	end	
    end
...
function onBeatHit()
	...
	setProperty('moreDark.visible', false)
